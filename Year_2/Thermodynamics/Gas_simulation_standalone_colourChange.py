...
class Gas:
    ...
    def __init__(self):
        ...
        while i < (len(Gas.balls)-1):
            ...
            self.__i = plt.Circle((Gas.balls[i].pos()[0],Gas.balls[i].pos()[1]), Gas.balls[i].size, fc= 'w')
    ...
    def next_frame(self, i):
        ...
        Gas.counter += 1
        # resets all the colours after a collision
        if Gas.counter == 1:
            time.sleep(0.1) 
            for patches in Gas.patches:            
                patches.set_fc('b')
        ...
        if Gas.counter == Gas.frames_to_collision:
            if Gas.ball2.size < 0:
                ...
                # change colour of patches that collided. 
                Gas.patches[Gas.balls.index(Gas.ball1)].set_fc('r')
            else:
                Gas.ball1.collide_ball(Gas.ball2)
                # change colour of patches that collided. 
                Gas.patches[Gas.balls.index(Gas.ball2)].set_fc('r')
                Gas.patches[Gas.balls.index(Gas.ball1)].set_fc('r')
...
if __name__ == '__main__':
    ...
    if Animate == 'True':
        ...
        anim = animation.FuncAnimation( fig1, 
                                        ...
                                        interval = 0.0001, # no. of ms pause/ frame,
                                        blit = False)
        plt.show()
